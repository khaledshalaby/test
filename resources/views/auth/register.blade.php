...
@section('content')
		<div class="container-fluid">
			<div class="row no-gutter">
								...
								<div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
									<div class="card-sigin">
										<div class="mb-5 d-flex"> <a href="{{ url('/' . $page='Home') }}"><img src="{{URL::asset('assets/img/brand/favicon.png')}}" class="sign-favicon ht-40" alt="logo"></a>
                                            <h1 class="main-logo1 ml-1 mr-0 my-auto tx-28">{{__('messages.site_title')}}</h1></div>
										<div class="card-sigin">
											<div class="main-signup-header">
												<h2>{{__('messages.welcome')}}</h2>
												<h5 class="font-weight-semibold mb-4"> {{__('messages.register')}}
                ...
                <div class="col-md-6 col-lg-6 col-xl-7 d-none d-md-flex bg-login">
