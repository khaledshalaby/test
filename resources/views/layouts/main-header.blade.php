					...
					<div class="main-header-right">
							...
							<li class="">
								<div class="dropdown  nav-itemd-none d-md-flex">
									<a href="#" class="d-flex  nav-item nav-link pl-0 country-flag1" data-toggle="dropdown" aria-expanded="false">
                                        ...
                                        @if (app()->getLocale() == 'ar')
                                            <img src="{{URL::asset('assets/img/flags/egypt_flag.jpg')}}" alt="Egypt-flag">
                                        @elseif (app()->getLocale() == 'en')
                                            <img src="{{URL::asset('assets/img/flags/us_flag.jpg')}}" alt="us-Flag">
                                        @endif
                                        </span>
										<div class="my-auto">
                                            @if (app()->getLocale() == 'ar')
									...
									<div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow" x-placement="bottom-end">
										<a href="{{ url('locale/en') }}" class="dropdown-item d-flex ">
											<span class="avatar  ml-1 mr-1 align-self-center bg-transparent"><img src="{{URL::asset('assets/img/flags/us_flag.jpg')}}" alt="Us Flag"></span>
											<div class="d-flex ml-2 mr-2">
												<span class="mt-2">English</span>
											</div>
										</a>
										<a href="{{ url('locale/ar') }}" class="dropdown-item d-flex">
											<span class="avatar  ml-1 mr-1 align-self-center bg-transparent"><img src="{{URL::asset('assets/img/flags/egypt_flag.jpg')}}" alt="Egypt Flag"></span>
											<div class="d-flex ml-2 mr-2">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href=""><img alt="User" src="{{URL::asset('assets/img/media/user.png')}}"></a>
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											<div class="main-img-user"><img alt="User" src="{{URL::asset('assets/img/media/user.png')}}" class=""></div>
											<div class="mr-2 my-auto ml-2">
                                    ...
                                    <a class="dropdown-item" href="{{ route('logout') }}"
                                     ...
                                     class="bx bx-log-out"></i>{{__('messages.sign_out')}}</a>
