				...
				<ul class="side-menu">
					...
					<li class="slide">
						<a class="side-menu__item" href="{{ url('/' . $page='home') }}">
                            ...
                            <span class="side-menu__label">{{ __('messages.main') }} </span></a>
					</li>
					<li class="side-item side-item-category">{{ __('messages.suppliers') }} </li>
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                            <span class = 'side-menu__icon'>
                                <i class="las la-lg la-mortar-pestle"></i>
                                {{-- <i class=" far fa-capsules"></i> --}}
                            </span>
                            <span class="side-menu__label">{{ __('messages.suppliers') }} </span>
                            <i class="angle fe fe-chevron-down"></i>
                            </a>
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='supplier-classification') }}">{{__('messages.supplier_classification')}}</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='suppliers') }}">{{__('messages.suppliers')}}</a></li>
